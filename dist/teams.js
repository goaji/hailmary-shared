...
exports.TEAMS_BY_SLUG = Object.fromEntries(exports.TEAMS.map((t) => [t.slug, t]));
exports.DEFAULT_TEAM = 'kc';
function getTeam(slug) {
    return exports.TEAMS_BY_SLUG[slug] ?? exports.TEAMS_BY_SLUG[exports.DEFAULT_TEAM];
}
 ...
 */
function getAdjacentTeams(currentSlug) {
    const index = exports.TEAMS.findIndex((team) => team.slug === currentSlug);
    if (index === -1) {
        return {};
    }
    return { previous: exports.TEAMS[index - 1], next: exports.TEAMS[index + 1] };
}
 ...
 * clears more.
 */
function onBrandColor(team) {
    const textRatio = (0, contrast_1.contrastRatio)(team.brand1, C_TEXT);
    const pageRatio = (0, contrast_1.contrastRatio)(team.brand1, C_PAGE);
    if (textRatio >= 4.5 || pageRatio >= 4.5) {
        return textRatio >= pageRatio ? C_TEXT : C_PAGE;
    }
    return (0, contrast_1.contrastRatio)(team.brand1, '#ffffff') >= (0, contrast_1.contrastRatio)(team.brand1, '#000000')
        ? '#ffffff'
        : '#000000';
}
/** Six teams shown in the header picker. */
exports.PICKER_TEAMS = ['kc', 'phi', 'dal', 'gb', 'pit', 'ne'];
